...
public partial class SaveMenuItemFormControl : ContentView
{
	...
	/* public static readonly BindableProperty CategoriesProperty = BindableProperty
	.Create(nameof(Categories), typeof(MenuCategoryModel[]), typeof(CategoriesListControl), Array.Empty<MenuCategoryModel>());
	...
	.Create(nameof(Item), typeof(MenuItemModel), typeof(CategoriesListControl), new MenuItemModel());
